...
// Rows and Columns as nodes in DSU
...
Explanation: [0,0] is the only stone on the plane, so you cannot remove it.
    * */
    ...
    class SolutionDFS {
        ...
        private void depthFirstSearch(List<Integer>[] adjacencyList, boolean[] visited, int stone) {
            visited[stone] = true;
    ...
    // O(N) - Number of stones. or
    class SolutionUFOptimized {
