...
public class CoundSubIslands {
    ...
    class SolutionBFS {
        ...
        private boolean isSubIsland(int x, int y, int[][] grid1, int[][] grid2, boolean[][] visited) {
            ...
            while (!pendingCells.isEmpty()) {
                ...
                for (int[] direction : directions) {
                    ...
                    if (canGo(nextX, nextY, totalRows, totalCols) && !visited[nextX][nextY] && isCellLand(nextX, nextY, grid2)) {
        ...
        private boolean canGo(int nextX, int nextY, int totalRows, int totalCols) {
            return nextX >= 0 && nextY >= 0 && nextX < totalRows && nextY < totalCols;
        }
    }
