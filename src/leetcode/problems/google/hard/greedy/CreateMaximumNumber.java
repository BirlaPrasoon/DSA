...
public class CreateMaximumNumber {
    ...
    // Pre-requisite... Most Competitive number i.e. create maximum number of length k from the given set of digits
    // keeping the relative ordering of the digits same.
...
// prob is we don't know how many elements we will take from nums1 and nums2
// so we will try for all combinations of k and find the max out of them

    class SolutionToQuestion {
