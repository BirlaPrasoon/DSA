...
public class MinimizeTheMaximumValueInAGrid {
...
*/
    ...
    // This question is same as Rank Transform of a matrix just with unique values. Stil do read the description to memorize that its the same problem.
